...
public final class ChangeChannelHandler extends AbstractMaplePacketHandler {
    ...
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        try {
            ...
            sb.append(chr.getName()).append(" failed to change channel!.\r\n");
            sb.append("----------------------------------------------------------------------------\r\n");
            sb.append(tools.StringUtil.stackTraceToString(e) + "\r\n");
            sb.append("----------------------------------------------------------------------------\r\n");
            sb.append("Player in the World Server? = ").append(chr.getClient().getWorldServer().isConnected(chr.getName())).append("\r\n");
            sb.append("Player in the Channel Server = ").append("idk");
            PrintError.print(PrintError.CHANGE_CHANNEL, sb.toString());
        }
    }
}
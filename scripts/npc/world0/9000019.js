...
if (cm.getGuild() != null) cm.getGuild().gainGP(3);
                ...
                if (cm.itemQuantity(4000329) > 49 && cm.itemQuantity(4010007) > 49 && cm.itemQuantity(4000331) > 49 && cm.itemQuantity(4000328) > 49 && cm.itemQuantity(4000324) > 49) { 
                    cm.gainItem(4001010, 1); 

...
&&
Edited Again, by Madelinesz from RaGEZONE
*/
...
function action(mode, type, selection) {
    ...
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            cm.sendNext("#e#bHello #r#h ##k,#b I have the job of giving jobs in SharpStory!#d Press next if you would like to use my services free-of-cost!");
        } else if (status == 1) {
            if (cm.getLevel() < 201 && cm.getJobId()==0 || cm.getJobId()==2000 || cm.getJobId()==1000) {
                if (cm.getLevel() < 8) {
                    cm.sendOk("#eSorry, but you have to be at least level 8 to use my services.");
                    status = 98;
                ...
                cm.sendSimple("#eSorry, but you have to be at least level 30 to make the #rSecond Job Advancement#k.");
                status = 98;
                ...
                cm.sendOk("#eSorry, but you have to be at least level 70 to make the #rThird Job Advancement#k.");
                status = 98;
                ...
                cm.sendOk("#eSorry, but you have to be at least level 120 to make the #rForth Job Advancement#k.");
                status = 98;
                ...
                status = 135;
                cm.sendYesNo("Congratulations on reaching such a high level. Do you want to Job Advance now?");
            } else if (cm.getLevel() < 201) {
                cm.sendOk("#eSorry, but you have already attained the highest level of your job's mastery.");
                status = 98;
            } else {
                cm.sendOk("#eSorry, but you have already attained the highest level of your job's mastery.");
                cm.dispose();
            ...
            cm.sendOk("#eGood luck with your training.");
            cm.dispose();
        } else if (status == 102) {
            if (cm.getJobId()==411) {
                status = 105;
            ...
            cm.sendSimple("#eWhich would you like to be? #b\r\n#L0#Warrior#l\r\n#L1#Magician#l\r\n#L2#Bowman#l\r\n#L3#Thief#l\r\n#L4#Pirate#l#k\r\n\r\n#eOr maybe you prefer Cygnus Knights?#k\r\n#L5##bDawn Warrior#l\r\n#L6#Night Walker#l\r\n#L7#Blaze Wizard#l\r\n#L8#Wind Archer#l\r\n#L9#Thunder Breaker#l#k\r\n\r\n#e#rOr maybe get some Aran action?\r\n#L10##gAran#l");
        } else if (status == 155) {
            if (selection == 0) {
                jobName = "Warrior";
                job = 100;
